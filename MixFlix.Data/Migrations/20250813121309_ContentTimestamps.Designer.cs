...
namespace MixFlix.Data.Migrations
{
    ...
    [Migration("20250813121309_ContentTimestamps")]
    partial class ContentTimestamps
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MixFlix.Data.ContentAvailability", b =>
                {
                    b.HasOne("MixFlix.Data.Content", "Content")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_content_availability_content_content_id");
                    ...
                    b.HasOne("MixFlix.Data.Service", "Service")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_content_availability_service_service_id");
